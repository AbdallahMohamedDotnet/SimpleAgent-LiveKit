---
name: code-refactor
description: "Refactor existing, working frontend or backend code into clear layers using accurate SOLID principles while preserving observable behavior. Use when asked to refactor, clean up, decouple, split a god class or component, remove duplication, introduce dependency injection, or reorganize code. Do not use for feature work, bug fixes, rewrites, or broad test-suite creation."
---
...
Keep moves small and verified. When the user asks for commits, follow [references/workflow/commits.md](references/workflow/commits.md). Otherwise leave changes uncommitted.
