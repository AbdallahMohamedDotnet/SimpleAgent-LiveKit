...
`interview join --interview-id ID`; it is refused unless the interview is still active and its
room has a running interviewer, since no agent is dispatched on a rejoin. The terminal prints a
